...
public class BagQuestions {
     ...
     */
    public int OneZeroBags(int[] weights, int[] values, int capacity, int n){
     ...
     *优化用1维数组解决01背包问题
     */
    public int OneZeroBags2(int[] weights, int[] values, int capacity, int n){
     ...
     */
    public int FullBangQuestions(int[] weights, int[] values, int capacity, int n){
        int[][] dp = new int[n+1][capacity+1];
        for(int i=0;i<n+1;i++){
            for(int j=0;j<capacity+1;j++){
                if(i==0 || j==0){
     ...
     *可重复取的物品按取k次尝试计算。
     */
    public int MultiBagQuestions(int[] weights, int[] values, int[] nums, int capacity, int n){
        int[] dp = new int[capacity+1];
        for(int i=0;i<n;i++){
            for(int j=capacity;j>=weights[i];j--){
     ...
     */
    public int MultiBagQuestions2(Integer[] weights, Integer[] values, Integer[] nums, int capacity, int n){
    ...
    public int hybidBagQuestions(Integer[] v, Integer[] w, Integer[] s, int volume, int n){
     ...
     *     //value[]为每个物品的价值
     */
    public int twoDemensionBag(int[] cost1, int[] cost2, int[] values, int n, int v,int u){
