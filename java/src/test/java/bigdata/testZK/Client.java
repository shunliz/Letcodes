...
public class Client {
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        String path1 = zooKeeper.create("/myservers/myclient"+args[0], "{cpu:0.5,mem:2046,disk:80g}".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
        System.out.println("success create znode:"+ path1);

        while(true){
            zooKeeper.setData("/myservers/myclient"+args[0], "{cpu:0.5,mem:2046,disk:80g}".getBytes(),-1);
            Thread.sleep(500);
        }
    }
}
