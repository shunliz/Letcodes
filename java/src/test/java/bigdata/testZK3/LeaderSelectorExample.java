...
public class LeaderSelectorExample
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
                CuratorFramework    client = CuratorFrameworkFactory.newClient("123.57.162.179:2181", new ExponentialBackoffRetry(1000, 3));
                clients.add(client);

                ExampleClient       example = new ExampleClient(client, PATH, "Client #" + args[0]);
